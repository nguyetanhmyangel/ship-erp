...
export class AdminApiAuthApiClient {
     ...
     * @return Success
     */
    login(body?: AuthenticatedRequest | undefined): Observable<AuthenticatedResponse> {
...
export class AdminApiPostApiClient {
     ...
     * @return Success
     */
    getPostsPaging(keyword?: string | null | undefined, categoryId?: string | null | undefined, pageIndex?: number | undefined, pageSize?: number | undefined): Observable<PostInListResponsePagedResult> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PostInListResponsePagedResult>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PostInListResponsePagedResult>;
        }));
    }

    protected processGetPostsPaging(response: HttpResponseBase): Observable<PostInListResponsePagedResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PostInListResponsePagedResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class AdminApiTokenApiClient {
     ...
     * @return Success
     */
    refresh(body?: TokenRequest | undefined): Observable<AuthenticatedResponse> {
    ...
    protected processRefresh(response: HttpResponseBase): Observable<AuthenticatedResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AuthenticatedRequest implements IAuthenticatedRequest {
    userName?: string | undefined;
    password?: string | undefined;

    constructor(data?: IAuthenticatedRequest) {
        if (data) {
    ...
    static fromJS(data: any): AuthenticatedRequest {
        data = typeof data === 'object' ? data : {};
        let result = new AuthenticatedRequest();
        result.init(data);
        return result;
    }
...
export class PostInListResponse implements IPostInListResponse {
    id?: string;
    name?: string | undefined;
    slug?: string | undefined;
    description?: string | undefined;
    ...
    constructor(data?: IPostInListResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PostInListResponse {
        data = typeof data === 'object' ? data : {};
        let result = new PostInListResponse();
        result.init(data);
        return result;
    }
...
export interface IPostInListResponse {
    id?: string;
    name?: string | undefined;
    slug?: string | undefined;
    description?: string | undefined;
...
export class PostInListResponsePagedResult implements IPostInListResponsePagedResult {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
    ...
    results?: PostInListResponse[] | undefined;

    constructor(data?: IPostInListResponsePagedResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["results"])) {
                ...
                for (let item of _data["results"])
                    this.results!.push(PostInListResponse.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PostInListResponsePagedResult {
        data = typeof data === 'object' ? data : {};
        let result = new PostInListResponsePagedResult();
        result.init(data);
        return result;
    }
...
export interface IPostInListResponsePagedResult {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
