...
import { AdminApiAuthApiClient, AuthenticatedRequest, AuthenticatedResponse } from 'src/app/api/admin-api.service.generated';
...
export class LoginComponent implements OnDestroy{
  ...
  login() {
    this.loading = true;
    var request: AuthenticatedRequest = new AuthenticatedRequest({
